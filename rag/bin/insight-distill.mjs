...
## 좋은 인사이트 예시
- "현재 이직 활동이 면접 단계에 진입했으며, 특정 회사(카카오페이)에 집중하고 있다"
...
[{"insight_text":"현재 이직 활동이 면접 단계에 진입했다","category":"life_phase","confidence":0.9,"evidence_summary":"카카오페이 면접 준비 문서, 이력서 최종 수정, 도메인 Q&A 작성","supersedes":null}]`;
