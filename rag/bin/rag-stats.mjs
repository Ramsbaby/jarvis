 ...
 *
 * 사용법: node ~/.openclaw-data/runtime/bin/rag-stats.mjs [--json]
 */
...
async function main() {
  ...
  else if (!ENV_SET)   warn('BOT_HOME 미설정 — XDG 폴백 경로 사용 중(비어있을 수 있음). 진짜 DB를 보려면: export BOT_HOME=~/.openclaw-data/runtime');
