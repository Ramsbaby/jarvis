...
CIRCUIT_FILE="${BOT_HOME:-${HOME}/.openclaw-data/runtime}/state/circuit-ask-claude.json"
CIRCUIT_LEDGER="${BOT_HOME:-${HOME}/.openclaw-data/runtime}/ledger/circuit-ask-claude.jsonl"
