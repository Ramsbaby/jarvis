...
_LINT_ESLINT_CONFIG="${_LINT_ESLINT_CONFIG:-${BOT_HOME:-${HOME}/.openclaw-data/jarvis/runtime}/config/eslint-gate.config.mjs}"
_LINT_BOT_HOME="${BOT_HOME:-${HOME}/.openclaw-data/jarvis/runtime}"
