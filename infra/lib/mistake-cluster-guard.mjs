  ...
  'cl-081997ea83d6da01': {
    ...
    guards: [
      ...
      // Guard 2: 실행 로그 대조를 통한 중복 실행 방지
      {
        ...
        params: {
          log_file: '~/.openclaw-data/runtime/state/execution-log.jsonl',
          hash_by_input: true,
        },
      ...
      // Guard 3: 상태 DB에 unique key 체크
      {
        ...
        params: {
          db_path: '~/.openclaw-data/runtime/state/execution-state.db',
      ...
      // Guard 6: 멱등성 가드 작동 상태 메트릭 추적
      {
        ...
        params: {
          metrics_file: '~/.openclaw-data/runtime/state/idempotency-metrics.jsonl',
          window_hours: 24,
        },
  ...
  'cl-0cece7e70f08a98f': {
    ...
    guards: [
      ...
      },
      {
        ...
        params: {
          result_dir: '~/.openclaw-data/runtime/reports/cluster-guard-cl-0cece7e70f08a98f',
