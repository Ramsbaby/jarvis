...
#
# 기록: JSONL append-only → ~/.openclaw-data/jarvis/runtime/logs/trajectory.jsonl
...
_TRAJECTORY_FILE="${BOT_HOME:-${HOME}/.openclaw-data/jarvis/runtime}/logs/trajectory.jsonl"
