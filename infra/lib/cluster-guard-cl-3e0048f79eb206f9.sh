...
readonly DB_PATH="${HOME}/.openclaw-data/runtime/state/command-state-${CLUSTER_ID}.db"
readonly STATE_DIR="${HOME}/.openclaw-data/runtime/state/cluster-guards"
readonly STATE_FILE="${STATE_DIR}/cl-3e0048f79eb206f9-command-state.json"
readonly LOCK_DIR="${HOME}/.openclaw-data/runtime/state/guard-locks"
