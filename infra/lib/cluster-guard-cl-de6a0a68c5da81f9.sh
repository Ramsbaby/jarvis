...
#
# 사용:
#   source ~/.openclaw-data/runtime/infra/lib/cluster-guard-cl-de6a0a68c5da81f9.sh
#
#   # 업로드 작업 검증
...
# 의존성
source "${HOME}/.openclaw-data/runtime/infra/lib/async-work-guard.sh" 2>/dev/null || {
...
STATE_DIR="${HOME}/.openclaw-data/runtime/state/cluster-guards"
REPORT_DIR="${HOME}/.openclaw-data/runtime/reports"
