...
#   source ~/projects/jarvis/infra/lib/file-guard-wrapper.sh
...
GUARD_SCRIPT="${GUARD_SCRIPT:-${JARVIS_HOME:-${HOME}/projects/jarvis}/infra/bin/file-existence-guard.sh}"
VALIDATOR_SCRIPT="${VALIDATOR_SCRIPT:-${JARVIS_HOME:-${HOME}/projects/jarvis}/infra/bin/claude-assertion-validator.mjs}"
...
Environment:
  ...
  JARVIS_HOME         - Jarvis home directory (default: \$HOME/projects/jarvis)
