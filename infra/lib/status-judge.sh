...
# 상수 정의
_JUDGE_STATE_DIR="${JUDGE_STATE_DIR:=${HOME}/.openclaw-data/jarvis/runtime/state/status-judge}"
_JUDGE_LOG_DIR="${JUDGE_LOG_DIR:=${HOME}/.openclaw-data/jarvis/runtime/logs}"
