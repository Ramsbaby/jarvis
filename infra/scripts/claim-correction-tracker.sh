...
# 재개: rm ~/.openclaw-data/runtime/state/stopped/claim-correction-tracker
if [[ -f "${HOME}/.openclaw-data/runtime/state/stopped/claim-correction-tracker" ]]; then
...
LEDGER="$HOME/.openclaw-data/runtime/state/claim-correction-ledger.jsonl"
