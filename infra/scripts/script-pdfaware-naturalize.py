...
SCRIPT_MD = Path.home() / '.openclaw-data/runtime/career/samsung-cnt-2026-04-v3/20-presentation-script-v11.md'
...
def main():
    ...
    log_path = Path.home() / f'.openclaw-data/runtime/state/script-pdfaware-log-{ts}.json'
