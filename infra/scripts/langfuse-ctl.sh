...
LANGFUSE_DIR="${BOT_HOME:-${HOME}/.openclaw-data/runtime}/docker/langfuse"
LOG_FILE="${BOT_HOME:-${HOME}/.openclaw-data/runtime}/logs/langfuse-ctl.log"
...
EOF
  ...
  echo ""
  echo "API keys for tracing (add to discord/.env or ~/.openclaw-data/runtime/.env):"
