...
LANGFUSE_DIR="${BOT_HOME:-${HOME}/.openclaw-data/jarvis/runtime}/docker/langfuse"
LOG_FILE="${BOT_HOME:-${HOME}/.openclaw-data/jarvis/runtime}/logs/langfuse-ctl.log"
...
EOF
  ...
  echo ""
  echo "API keys for tracing (add to discord/.env or ~/.openclaw-data/jarvis/runtime/.env):"
