...
# 재개: rm ~/.openclaw-data/jarvis/runtime/state/stopped/bot-degraded-mode
if [[ -f "${HOME}/.openclaw-data/jarvis/runtime/state/stopped/bot-degraded-mode" ]]; then
...
JARVIS_DIR="$HOME/.openclaw-data/jarvis/runtime"
