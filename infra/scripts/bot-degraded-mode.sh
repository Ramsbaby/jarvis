...
# 재개: rm ~/.openclaw-data/runtime/state/stopped/bot-degraded-mode
if [[ -f "${HOME}/.openclaw-data/runtime/state/stopped/bot-degraded-mode" ]]; then
...
JARVIS_DIR="$HOME/.openclaw-data/runtime"
