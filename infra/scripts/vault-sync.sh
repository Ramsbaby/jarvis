...
#
# 미러링 매핑:
#   ~/.openclaw-data/runtime/rag/teams/reports/{team}-*.md  → ~/Jarvis-Vault/03-teams/{team}/
#   ~/.openclaw-data/runtime/docs/*.md                      → ~/Jarvis-Vault/06-knowledge/architecture/
#   ~/.openclaw-data/runtime/rag/teams/proposals-tracker.md → ~/Jarvis-Vault/03-teams/
...
# ralph runner가 ~/.openclaw-data/runtime/wiki/05-career/interview-curated/에 누적하는 모범답안 + 라운드 요약을
