...
const ENV_PATH = process.env.ENV_PATH || join(HOME, '.openclaw-data/jarvis/runtime', '.env');
...
const POLICY_FILE  = join(HOME, '.openclaw-data/jarvis/runtime', 'config', 'update-policy.json');
