 ...
 * ~/.openclaw-data/runtime/context/claude-memory/ 에 domain-full.md / domain-summary.md 저장.
 *
...
const SESSIONS_DIR = join(HOME, '.openclaw-data/runtime', 'context', 'claude-code-sessions');
const OUTPUT_DIR   = join(HOME, '.openclaw-data/runtime', 'context', 'claude-memory');
