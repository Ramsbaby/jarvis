...
//
// Usage:
//   node ~/projects/jarvis/infra/scripts/failure-class-report.mjs              # 최근 7일
//   node ~/projects/jarvis/infra/scripts/failure-class-report.mjs --days=1     # 최근 1일
//   node ~/projects/jarvis/infra/scripts/failure-class-report.mjs --days=30    # 최근 30일
//   node ~/projects/jarvis/infra/scripts/failure-class-report.mjs --task=<id>  # 단일 태스크
//
...
const RETRY_LOG_CANDIDATES = [
  `${HOME}/.openclaw-data/runtime/logs/retry.jsonl`,
  `${HOME}/.openclaw-data/runtime/logs/retry.jsonl`,
];
