...
# 출력:   ~/.openclaw-data/runtime/docs/SYSTEM-OVERVIEW.md
#
...
if [[ -z "${BOT_HOME:-}" ]]; then
  if [[ -d "${HOME}/.openclaw-data/runtime" ]]; then
...
import json, os
B = os.environ.get('BOT_HOME', os.path.expanduser('~/.openclaw-data/runtime'))
