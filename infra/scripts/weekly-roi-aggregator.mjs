...
const roiDir = path.join(homeDir, '.openclaw-data/runtime/rag/roi-reports');
const resultsDir = path.join(homeDir, '.openclaw-data/runtime/results');
const logsDir = path.join(homeDir, '.openclaw-data/runtime/logs');
...
function collectInsightsByTask() {
  ...
  try {
    const insightsDir = path.join(homeDir, '.openclaw-data/runtime/rag/auto-insights');
...
function collectDecisionsByTask() {
  ...
  try {
    const decisionsFile = path.join(homeDir, `.openclaw-data/runtime/rag/decisions-${week}.md`);
