...
const roiDir = path.join(homeDir, '.openclaw-data/jarvis/runtime/rag/roi-reports');
const resultsDir = path.join(homeDir, '.openclaw-data/jarvis/runtime/results');
const logsDir = path.join(homeDir, '.openclaw-data/jarvis/runtime/logs');
...
function collectInsightsByTask() {
  ...
  try {
    const insightsDir = path.join(homeDir, '.openclaw-data/jarvis/runtime/rag/auto-insights');
...
function collectDecisionsByTask() {
  ...
  try {
    const decisionsFile = path.join(homeDir, `.openclaw-data/jarvis/runtime/rag/decisions-${week}.md`);
