...
// Ledger: ~/.openclaw-data/runtime/ledger/tasks-prompt-path-audit.jsonl

import fs from 'node:fs';
import os from 'node:os';

const HOME = os.homedir();
const TASKS_FILE = `${HOME}/.openclaw-data/runtime/config/tasks.json`;
const LEDGER_DIR = `${HOME}/.openclaw-data/runtime/ledger`;
const LEDGER_FILE = `${LEDGER_DIR}/tasks-prompt-path-audit.jsonl`;
const MONITORING_CANDIDATES = [
  `${HOME}/.openclaw-data/runtime/config/monitoring.json`,
  `${HOME}/.openclaw-data/runtime/config/monitoring.json`,
];
const BOT_HOME_CANDIDATES = [`${HOME}/.openclaw-data/runtime`, `${HOME}/.jarvis`];
