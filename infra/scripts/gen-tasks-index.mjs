 ...
 *
 * Reads ~/.openclaw-data/jarvis/runtime/config/tasks.json and emits:
...
function main() {
  ...
  md.push('>');
  md.push('> Source: `~/.openclaw-data/jarvis/runtime/config/tasks.json` · Team mapping: mirror of `~/jarvis-board/lib/map/team-registry.ts`');
  md.push('');
  ...
  md.push('');
  md.push('```bash');
  md.push('node ~/.openclaw-data/jarvis/infra/scripts/gen-tasks-index.mjs');
  md.push('```');
  md.push('');
