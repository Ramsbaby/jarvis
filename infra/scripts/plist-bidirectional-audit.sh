...
# 출력: ~/.openclaw-data/runtime/ledger/plist-bidirectional-audit.jsonl + Discord 리포트
...
# 이슈 있음 — 상세 리포트
{
  ...
  echo "-# ledger: \`~/.openclaw-data/runtime/ledger/plist-bidirectional-audit.jsonl\` · 다음 실행: 다음 주 일요일 05:00 KST"
}
