...
LOG="${HOME}/.openclaw-data/runtime/logs/rule-hook-coverage-audit.log"
RULES_MD="${HOME}/.openclaw-data/runtime/wiki/meta/learned-mistakes.md"
HOOKS_DIR="${HOME}/.claude/hooks"
JARVIS_BIN="${HOME}/projects/jarvis/infra/scripts"
...
LEDGER="${HOME}/.openclaw-data/runtime/ledger/rule-hook-coverage.jsonl"
