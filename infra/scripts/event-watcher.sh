...
# 재개: rm ~/.openclaw-data/runtime/state/stopped/event-watcher
if [[ -f "${HOME}/.openclaw-data/runtime/state/stopped/event-watcher" ]]; then
...
# 30초마다 ~/.openclaw-data/runtime/state/events/*.trigger 파일 스캔
