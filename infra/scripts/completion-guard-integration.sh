...
#
# 사용:
#   source ~/.openclaw-data/runtime/scripts/completion-guard-integration.sh
#   verify_completion_with_guard "task-id" "target_count" "completed_count"

set -euo pipefail

GUARD_LOG="${HOME}/.openclaw-data/runtime/logs/completion-guard.log"
VALIDATOR_SCRIPT="${HOME}/.openclaw-data/runtime/scripts/completion-validator.sh"
