...
LOG="${HOME}/.openclaw-data/runtime/logs/learning-loop-audit.log"
LEDGER="${HOME}/.openclaw-data/runtime/ledger/learning-loop-audit.jsonl"
...
MISTAKES_FILE="${HOME}/.openclaw-data/runtime/wiki/meta/learned-mistakes.md"
mistakes_added=0
...
EUREKA_FILE="${HOME}/.openclaw-data/runtime/wiki/meta/eureka.jsonl"
eureka_added=0
...
retros_added=$(find "${HOME}/.openclaw-data/runtime/wiki/retros" -name "*.md" -mtime -7 -type f 2>/dev/null | wc -l | tr -d ' ')

# ─── 6) ghost_count: 최근 ghost-tool-detector 결과 ───
ghost_count=0
GHOST_LEDGER="${HOME}/.openclaw-data/runtime/ledger/ghost-tool-detector.jsonl"
...
coverage_pct="0.0"
COV_LEDGER="${HOME}/.openclaw-data/runtime/ledger/rule-hook-coverage-audit.jsonl"
