...
MATERIAL_DIR="${PREPLY_MATERIAL_DIR:-${HOME}/.openclaw-data/runtime/preply-materials}"
...
f = sys.argv[1]
LEDGER = os.path.expanduser('~/.openclaw-data/runtime/state/preply-verify-ledger.jsonl')
html = open(f).read()
classes = {}
