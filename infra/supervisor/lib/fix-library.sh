...
1. ~/projects/jarvis/infra/docs/MAP.md  # 시스템 맵 — 본 결함이 어느 컴포넌트인지 매핑
2. ~/projects/jarvis/infra/docs/ARCHITECTURE.md  # self-healing 4-layer 구조
3. ~/projects/jarvis/infra/docs/OPERATIONS.md  # 운영 + escalation tree
4. ~/.openclaw-data/runtime/wiki/meta/learned-mistakes.md  # 오답노트 — 같은 결함 과거 진단
5. ~/projects/jarvis/infra/supervisor/lib/fix-library.sh  # 안전 fix 함수 reference
...
- bash ~/.openclaw-data/runtime/scripts/<known-script>.sh
...
EOF
    ...
    local ask_claude="${HOME}/projects/jarvis/infra/bin/ask-claude.sh"
