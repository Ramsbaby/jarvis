...
WEEK=$(date +%Y-W%V)
ROI_DIR="$HOME/.openclaw-data/runtime/rag/roi-reports"
LOG_FILE="$HOME/.openclaw-data/runtime/logs/weekly-roi.log"
AGGREGATOR="$HOME/.openclaw-data/runtime/scripts/weekly-roi-aggregator.mjs"
