...
#         vault-sync.sh → ~/Jarvis-Vault/06-knowledge/architecture/ 자동 반영
#
...
│       morning-standup / board-meeting / tqqq / news / doctor…   │
├─────────────────────────────────────────────────────────────────┤
...
| Uptime Kuma | 외부 모니터링 (`http://<LOCAL_SERVER_IP>:3001`) |
