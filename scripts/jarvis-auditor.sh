...
# 보호 파일 (자동수정 금지)
PROTECTED_FILES="discord-bot.js monitoring.json tasks.json company-dna.md autonomy-levels.md .env"
...
run_launchagent_audit() {
    ...
    local services=("ai.jarvis.discord-bot" "ai.jarvis.watchdog" "ai.openclaw.glances")
    local uid
    uid=$(id -u)
    local found=0
