...
<img src="https://img.shields.io/badge/크론_태스크-63개-orange?style=flat-square" alt="63 크론">
...
| 능동적 자동화 | 63개 예약 태스크 (12팀) | 반응형만 | 비주얼 설정 필요 |
| 자가복구 | 4계층 자동 복구 | ❌ | ❌ |
...
- `/run <태스크>`로 63개 크론 태스크 중 아무거나 즉시 실행
